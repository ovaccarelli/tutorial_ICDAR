...
# Observability must be configured before constructing an Agent.
langfuse = configure_observability(required=True)
if langfuse is None:  # Defensive type narrowing; required mode raises on failure.
    raise RuntimeError("Langfuse observability was not configured")
