...
if __name__ == "__main__":
    ...
    # Solution: call the listing tool.
    print(list_my_available_documents())

    # EXERCISE 2 - Extract and print text from a Markdown or text file
    # Solution: call the plain-text extraction tool on the train ticket.
    print(extract_text_from_md_or_txt_file("Train_Ticket.md"))

    # EXERCISE 3 - Extract and print text from an image file using OCR
    # Solution: call the OCR tool on the restaurant receipt image.
    print(extract_text_from_image_file("Restaurant.png"))
