...
agent = Agent(
    ...
    instructions=(
        ...
        "the HAL 9000 policy PDF, use the RAG search tool. If a tool asks you to "
        "retry, follow its guidance and choose the appropriate tool. Mention the "
        "filenames you use."
    ),
...
if __name__ == "__main__":
    # SOLUTION 2 - Test the agent with document tools and RAG retrieval:
